...
DATA_DIR = Path(os.environ.get('LUNARIA_DATA_DIR') or (ROOT / 'data')).expanduser()
UPLOADS_DIR = Path(os.environ.get('LUNARIA_UPLOADS_DIR') or (DATA_DIR / 'uploads')).expanduser()
